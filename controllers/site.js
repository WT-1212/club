/*!
 * aresclub - site index controller.
...
exports.index = function (req, res, next) {
  ...
  if (req.query.fulcrum) { //设置节点
    req.session.fulcrumNow = req.query.fulcrum;
  }
  ...
  if (req.session.fulcrumNow && req.session.fulcrumNow != '' &&
    req.session.fulcrumNow != 'all') {
    query.fulcrum = req.session.fulcrumNow;
  }
