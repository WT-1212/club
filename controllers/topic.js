...
exports.index = function (req, res, next) {
  ...
  var fulcrumNow = req.session.fulcrumNow;
  var ep = EventProxy.create(events,
    function (topic, other_topics, no_reply_topics, is_collect) {
      res.render('topic/index', {
        ...
        is_uped: isUped,
        fulcrums: config.fulcrums,
        fulcrumNow: fulcrumNow ? fulcrumNow : 'all',
...
exports.put = function (req, res, next) {
  ...
  var fulcrum = validator.trim(req.body.fulcrum || '');
  var tab_img = validator.trim(req.body.tab_img || '');
  ...
  Topic.newAndSave(title, content, tab, req.session.user._id, fulcrum, tab_img, function (err, topic) {
    if (err) {
      return next(err);
    }
