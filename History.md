...
==================
  ...
  * unit test cases
  * #132 Add https:// validate on user.js cnodejs/aresclub#132 (@meteormatt)
  * Add 0.10 for travis
...
==================
  ...
  * remove customHost
  * add .naeignore files
  * * merge caresclub to aresclub; * add more settings for custom site; * fixed upload.js not worked bug;
